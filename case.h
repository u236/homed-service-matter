...
struct SessionInfo
{
    ...
    bool active;
    bool resumptionPendingValidation;
    ...
    SessionInfo(void) : localSessionId(0), peerSessionId(0), peerPort(0), peerNodeId(0), localMessageCounter(0), active(false), resumptionPendingValidation(false), idleInterval(500), activeInterval(300), activeThreshold(4000) {}
};
